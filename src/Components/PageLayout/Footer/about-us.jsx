        ...
        return (
            <div className="grid wide-footer row-footer">
                <div className="col l-2 footer-icon">
                    <img src="data:image/png;base64," className="footer-icon__css" alt="logo" />
                    <div className="footer-from">
                        <div>© 2022 Meta Film.</div>
                        <div>All rights reserved</div>
                    </div>
                </div>
                <div className="col l-2">
                    <ul className="about">
                        <li className="about-header">META FILM</li>
                        <li className="about-info"><a href="/">New Film</a></li>
                ...
                <img className="footer-img" src="https://thietkenhanh24h.com/uploads/thietkenhanh/images/1101/cover_2-01.jpg" alt="" />
            </div>
        )
    }
}
